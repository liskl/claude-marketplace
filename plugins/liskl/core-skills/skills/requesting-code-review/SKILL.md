...
Dispatch aatech-tools:code-reviewer subagent to catch issues before they cascade.
...
Use Task tool with aatech-tools:code-reviewer type, fill template at `code-reviewer.md`
